...
/*
 * This file is a bundle generated by `bun build` from the TypeScript
 * sources in util/config/configurator. In addition to code developed at the Apache
 * Software Foundation under the Apache License, Version 2.0, it embeds
 * the following third-party npm packages, each under its own licence:
 *
 *   MIT:          @clack/core, @clack/prompts, sisteransi
 *   ISC:          picocolors
 *
 * The copyright holders of these packages and the full text of each
 * licence are listed in the LICENSE file distributed with this work.
 * Do not edit this file by hand; rebuild it from the sources.
 */
